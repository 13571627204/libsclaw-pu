...
/**
 * Inspect skill archives without installing them
 * Returns the skills contained in each uploaded archive and whether they already exist locally, so clients can ask how to resolve duplicates before uploading.
 */
export const inspectSkills = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<InspectSkillsData, ThrowOnError>) => {
    return (options?.client ?? client).post<InspectSkillsResponse, InspectSkillsError, ThrowOnError>({
        ...options,
        ...formDataBodySerializer,
        headers: {
            'Content-Type': null,
...
/**
 * Get the knowledge base Wiki page tree
 */
export const getKnowledgeWikiTree = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetKnowledgeWikiTreeData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetKnowledgeWikiTreeResponse, GetKnowledgeWikiTreeError, ThrowOnError>({
        ...options,
        url: '/api/v1/knowledge-bases/{kb_id}/wiki/tree'
    });
};

/**
 * Export a knowledge base Wiki as a Markdown ZIP archive
 */
export const exportKnowledgeWiki = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ExportKnowledgeWikiData, ThrowOnError>) => {
    return (options?.client ?? client).get<ExportKnowledgeWikiResponse, ExportKnowledgeWikiError, ThrowOnError>({
        ...options,
        url: '/api/v1/knowledge-bases/{kb_id}/wiki/export'
    });
};

/**
 * Get a knowledge base Wiki page
 */
export const getKnowledgeWikiPage = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetKnowledgeWikiPageData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetKnowledgeWikiPageResponse, GetKnowledgeWikiPageError, ThrowOnError>({
        ...options,
        url: '/api/v1/knowledge-bases/{kb_id}/wiki/pages'
    });
};

/**
 * Create a knowledge base Wiki page
 */
export const createKnowledgeWikiPage = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateKnowledgeWikiPageData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateKnowledgeWikiPageResponse, CreateKnowledgeWikiPageError, ThrowOnError>({
        ...options,
        url: '/api/v1/knowledge-bases/{kb_id}/wiki/pages'
    });
};
...
/**
 * Update a knowledge base Wiki page
 */
export const updateKnowledgeWikiPage = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateKnowledgeWikiPageData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateKnowledgeWikiPageResponse, UpdateKnowledgeWikiPageError, ThrowOnError>({
        ...options,
        url: '/api/v1/knowledge-bases/{kb_id}/wiki/pages'
    });
};
...
/**
 * Delete a knowledge base Wiki page
 */
export const deleteKnowledgeWikiPage = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteKnowledgeWikiPageData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteKnowledgeWikiPageResponse, DeleteKnowledgeWikiPageError, ThrowOnError>({
        ...options,
        url: '/api/v1/knowledge-bases/{kb_id}/wiki/pages'
    });
};
...
/**
 * Rebuild the knowledge base Wiki indexes
 */
export const rebuildKnowledgeWikiIndex = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<RebuildKnowledgeWikiIndexData, ThrowOnError>) => {
    return (options?.client ?? client).post<RebuildKnowledgeWikiIndexResponse, RebuildKnowledgeWikiIndexError, ThrowOnError>({
        ...options,
        url: '/api/v1/knowledge-bases/{kb_id}/wiki/rebuild'
    });
};

/**
 * Move a knowledge base Wiki page or directory
 */
export const moveKnowledgeWikiPath = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<MoveKnowledgeWikiPathData, ThrowOnError>) => {
    return (options?.client ?? client).post<MoveKnowledgeWikiPathResponse, MoveKnowledgeWikiPathError, ThrowOnError>({
        ...options,
        url: '/api/v1/knowledge-bases/{kb_id}/wiki/move'
    });
};

/**
 * Delete a knowledge base Wiki page or directory
 */
export const deleteKnowledgeWikiPath = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteKnowledgeWikiPathData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteKnowledgeWikiPathResponse, DeleteKnowledgeWikiPathError, ThrowOnError>({
        ...options,
        url: '/api/v1/knowledge-bases/{kb_id}/wiki/paths'
    });
};

/**
 * Import Markdown files, folders, or ZIP archives into the Wiki
 */
export const importKnowledgeWiki = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ImportKnowledgeWikiData, ThrowOnError>) => {
    return (options?.client ?? client).post<ImportKnowledgeWikiResponse, ImportKnowledgeWikiError, ThrowOnError>({
        ...options,
        ...formDataBodySerializer,
        headers: {
            'Content-Type': null,
        ...
        url: '/api/v1/knowledge-bases/{kb_id}/wiki/import'
    });
};

/**
 * Get the knowledge base Wiki graph
 */
export const getKnowledgeWikiGraph = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetKnowledgeWikiGraphData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetKnowledgeWikiGraphResponse, GetKnowledgeWikiGraphError, ThrowOnError>({
        ...options,
        url: '/api/v1/knowledge-bases/{kb_id}/wiki/graph'
    });
};
...
/**
 * Get public WebUI and LibsClaw versions
 */
