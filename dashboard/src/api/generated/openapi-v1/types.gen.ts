...
export type UploadSkillsBatchData = {
    ...
    query?: {
        /**
         * How to handle skills that already exist locally
         */
...
export type InspectSkillsData = {
    body: {
        files: Array<((Blob | File))>;
    };
};

export type InspectSkillsResponse = (SuccessEnvelope);

export type InspectSkillsError = unknown;
