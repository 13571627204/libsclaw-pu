        ...
        "metadata": {
            ...
            "ai": {
                ...
                "items": {
                    ...
                    "provider_settings.gpt_image_base_url": {
                        "description": "GPT-Image-2 Base URL",
                        "type": "string",
                        "hint": "用于文生图和图生图工具，默认 https://api.apiyi.com/v1。",
                    },
                    "provider_settings.gpt_image_api_key": {
                        "description": "GPT-Image-2 API Key",
                        "type": "string",
                        "hint": "填写后将启用 generate_image 工具。",
                    },
